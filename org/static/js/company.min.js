    ...
    $(".tipExpire .expire_close").bind("click", function () {
        ...
        submitHandler: function (a) {
            ...
            c += "[", $("#stagesList > li").each(function (a) {
                d = $(this).children('input[name="select_invest_hidden"]').val(), e = $(this).children('input[name="stageorg"]').val() != $(this).children('input[name="stageorg"]').attr("placeholder") ? $(this).children('input[name="stageorg"]').val() : "", c += a == $("#stagesList > li").length - 1 ? '{"stage":"' + d + '","org_index":"' + e + '"}' : '{"stage":"' + d + '","org_index":"' + e + '"},'
